const data = {
  google_information: {
    ...
    rightSide: [
      "Negative information in Internet is every day easier to detect, everyone who can access the Internet could make a research in Google typing your Name and Surname or your company data and easily obtain every kind of information without any filter or limit.",
      "The majority of the users do not distinguish between fake news or false content generated for anonymous users with the aim of perjudicate your digital reputation or your company credibility. That’s why World Delete developed know-how that permit us to guarantee our job.",
    ],
    class_2: "",
    class_5: "",
    class_6: "",
  ...
  digital_media: {
    ...
    class_6: "",
    box_primary: "",
    box_secondary: "_box_secondary_digital_media",
    triangleVisible: true,
  },
  video_photography: {
  ...
  mentions_comments: {
    ...
    class_6: "",
    box_primary: "",
    box_secondary: "_box_secondary_mentions_comments",
    triangleVisible: true,
  },
  about_first: {
    title: (
    ...
    rightSide: [
      <>
        There are no experiments or failed attempts <br />
        here at World Delete.We get it right the first <br />
        time and therefore we can apply a money-back <br />
        guarantee. – all our customers get the results <br />
        they need or a full refund of the price.
      </>,
    ],
    class_2: "_title_primary_baner_about_",
    class_5: "",
    class_6: "_text_secondary_baner_about_",
    box_primary: "_box_secondary_digital_media",
    box_secondary: "_box_secondary_digital_media",
  ...
  about_second: {
    ...
    text_1: [
      ...
      "200% per annul in recent years due to the ease with which users",
      "can publish anonymous, unfavourable comments on the Internet.",
    ],
    rightSide: [""],
    class_2: "_title_about_second",
    class_5: "",
    class_6: "",
    box_primary: "_box_secondary_digital_media",
    box_secondary: "_box_secondary_digital_media",
  ...
  content_text_about: {
    title_primary: (
      <>
        Delete content <br /> on the Internet
      </>
    ),
    text_secondary: [
      <>
        Social networks, digital press, photographs, videos, iCloud database
        documentation, negative <br /> comments or reviews and any other kind of
        detrimental information that may affect the reputation <br /> and
        credibility of companies, institutions and individuals.
      </>,
    ],
  },
  content_text_out_services: {
    title_primary: "Our services",
    text_secondary: [
      <>
        <span className="_text_span_about_">World Delete</span> <br />
        Protection of the on-line <br /> reputation of natural and <br /> legal
        persons.
        <br />
      </>,
      <>
        <span className="_text_span_about_">World Reputation</span>
        <br /> Automatic and manual monitoring
        <br /> of content published on the Internet.
        <br />
      </>,
      <>
        <span className="_text_span_about_">World Intelligence</span>
        <br /> Develops internal apps for public
        <br /> bodies and large corporations
      </>,
    ],
  },
  FinancialCompliance: {
    title: (
      <>
        Can you imagine how it would affect you if banks, <br /> governments and
        companies suspected you of <br /> being a negative part of society?
      </>
    ),
    text_1: [
      "Currently there are three well-known and frequently-used",
      "databases to which only the credit institutions,",
      "",
    ],
    rightSide: [""],
    class_2: "_fontSize36",
    class_5: "",
    class_6: "",
    box_primary: "_financial_compliance_box_primary",
    box_secondary: "",
    triangleVisible: false,
  },
};
