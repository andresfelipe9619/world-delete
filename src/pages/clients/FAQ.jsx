...
const items = [
  ...
  {
    id: 8,
    title: "How long does World Delete take to eliminate information from the Internet?",
    description:
  ...
  {
    id: 10,
    title: "Can World Delete delete any information in any language from the Internet?",
    description:
  ...
  {
    id: 11,
    title: "Once World Delete has deleted the content is it possible for it to reappear?",
    description:
